// Package grpc maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid grpc message")
...
// Source delivers messages. A grpc client library implements it.
