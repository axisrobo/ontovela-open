// Package dds maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid dds message")
...
// Source delivers messages. A dds client library implements it.
