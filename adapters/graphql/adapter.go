// Package graphql maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid graphql message")
...
// Source delivers messages. A graphql client library implements it.
