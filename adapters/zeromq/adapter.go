// Package zeromq maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid zeromq message")
...
// Source delivers messages. A zeromq client library implements it.
