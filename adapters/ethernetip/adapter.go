// Package ethernetip maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid ethernetip message")
...
// Source delivers messages. A ethernetip client library implements it.
