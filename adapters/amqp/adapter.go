// Package amqp maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid amqp message")
...
// Source delivers messages. A amqp client library implements it.
