// Package modbus maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid modbus message")
...
// Source delivers messages. A modbus client library implements it.
