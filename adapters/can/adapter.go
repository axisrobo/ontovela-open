// Package can maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid can message")
...
// Source delivers messages. A can client library implements it.
