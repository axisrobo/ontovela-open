// Package mqttsn maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid mqttsn message")
...
// Source delivers messages. A mqttsn client library implements it.
