// Package stomp maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid stomp message")
...
// Source delivers messages. A stomp client library implements it.
