// Package redis maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid redis message")
...
// Source delivers messages. A redis client library implements it.
