// Package profinet maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid profinet message")
...
// Source delivers messages. A profinet client library implements it.
