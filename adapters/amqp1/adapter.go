// Package amqp1 maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid amqp1 message")
...
// Source delivers messages. A amqp1 client library implements it.
