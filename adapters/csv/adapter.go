// Package csv maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid csv message")
...
// Source delivers messages. A csv client library implements it.
