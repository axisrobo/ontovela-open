// Package lorawan maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid lorawan message")
...
// Source delivers messages. A lorawan client library implements it.
