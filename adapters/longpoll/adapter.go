// Package longpoll maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid longpoll message")
...
// Source delivers messages. A longpoll client library implements it.
