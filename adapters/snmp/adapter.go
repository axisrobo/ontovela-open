// Package snmp maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid snmp message")
...
// Source delivers messages. A snmp client library implements it.
