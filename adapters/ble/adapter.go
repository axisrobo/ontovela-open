// Package ble maps protocol messages to ONTOVELA assertions through the
...
var ErrInvalidMessage = errors.New("invalid ble message")
...
// Source delivers messages. A ble client library implements it.
